...
const ContactForm: React.FC = () => {
  ...
  const validate = () => {
    ...
    if (!formData.form_name) {
      tempErrors.service = 'Debe Introducir un nombre.'
      return;
    }
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    form_service: formData.form_service,
  };

  console.log('Verificando los parámetros a enviar:', templateParams);
        ...
        <form ref={form} onSubmit={handleSubmit} noValidate>
          <div className="mb-4">
            <input type="text" 
                  ...
                  placeholder="Nombre" className="w-full p-3 bg-gray-200 rounded border border-transparent focus:outline-none focus:ring-2 focus:ring-blue-500" 
                  name="form_name"/>
          </div>
{          <div className="mb-4">
            <input type="email" 
          ...
          <div className="mb-4">
            <input type="tel" 
                   value={formData.form_phone} onChange={handleChange} placeholder="Teléfono (Opcional)" className="w-full p-3 bg-gray-200 rounded border border-transparent focus:outline-none focus:ring-2 focus:ring-blue-500" name="form_phone"/>
          </div>
          <div className="mb-4">
            <select
              id="select-label"
              ...
              onChange={handleChange}
              className="w-full p-3 bg-gray-200 rounded border border-transparent focus:outline-none focus:ring-2 focus:ring-blue-500 mb-4"
              name="form_service"
            >
          ...
          <button type="submit" disabled={sending} className="w-full bg-blue-600 text-white font-bold p-3 rounded hover:bg-blue-700 transition-colors duration-300">
